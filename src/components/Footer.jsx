  ...
  return (
    <footer className="w-full" role="contentinfo">
      ...
      <div className="bg-white py-6">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 flex justify-start">
          <img
            src={Logo}
      ...
      {/* Tengah - Info & Maps */}
      <div className="bg-[#002E5B] text-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-12 flex flex-col md:flex-row md:items-start md:justify-between gap-10">
          {/* Info UCIC */}
